      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap mx-5 md:mx-14 justify-center">
            {Object.keys(products).length === 0 && 'Sorry All the hoodies are out of stock! New Stock Coming Soon'}
              ...
              <Link passHref key={products[item]._id} href={`/product/${products[item].slug}`}>
                <div className="lg:w-1/4 md:w-1/2 p-4 w-full block shadow-lg">
                  ...
                  <div className="mt-4 mx-8 text-center md:text-left ">
                    <h2 className="text-gray-500 text-xs tracking-widest title-font mb-1">Hoodies</h2>
                    <h3 className="text-black title-font text-lg font-medium">{products[item].title}</h3>
